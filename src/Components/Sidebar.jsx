  ...
  return (
    <div className='w-[25%] h-full p-2  flex-col gap-2 text-white hidden lg:flex'>
      <div className='bg-[#121212] h-[20%] rounded flex flex-col justify-around'>
        <div onClick={()=>navigate('/')} className="flex items-center gap-2 pl-8 py-4 hover:bg-[#ffffff26] cursor-pointer">
      ...
      <div className='bg-[#121212] h-[80%] rounded'>
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1">
            ...
            <button className='px-4 py-1.5 bg-white text-[15px] cursor-auto text-black 
            rounded-full mt-4'>
                Create Playlist
            </button>
        </div>
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1">
            ...
            <p className='font-light'>we'll kepp you update on new episode</p>
            <button className='px-4 py-1.5 bg-white text-[15px] cursor-auto text-black 
            rounded-full mt-4'>
                Browse podcasts
            </button>
